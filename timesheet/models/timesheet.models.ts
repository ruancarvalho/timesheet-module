// src/app/modules/timesheet/models/timesheet.models.ts
...
export interface TimesheetEntry {
  taskId: string;
  date: DateYMD;
  value: MDValue; // 0 means "no entry" (we generally omit zeros in FE arrays)
}
...
export interface TimesheetWeek {
  ...
  version: string;       // ETag or optimistic concurrency token
  datesInWeek: DateYMD[]; // 7 items, provided by backend (Mon..Sun)
